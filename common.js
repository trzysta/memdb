...
try {
  ...
  const HOLYDAYS_2022 = [
    ...
    [1,5,6,11,12,13,19,20,26,27,11],	
    [3,4,10,11,17,18,24,25,26,31]
  ]
    
  const HOLYDAYS_MONTH_2022_1 = [1,2,6,8,9,15,16,22,23,29,30];
  const HOLYDAYS_MONTH_2022_2 = [5,6,12,13,19,20,26,27];
  const HOLYDAYS_MONTH_2022_3 = [5,6,12,13,19,20,26,27];
  const HOLYDAYS_MONTH_2022_4 = [2,3,9,10,16,17,18,23,24,30];	
  const HOLYDAYS_MONTH_2022_5 = [1,3,7,8,14,15,21,22,28,29];
  const HOLYDAYS_MONTH_2022_6 = [4,5,11,12,16,18,19,25,26];
  const HOLYDAYS_MONTH_2022_7 = [2,3,9,10,16,17,23,24,30,31];	
  const HOLYDAYS_MONTH_2022_8 = [6,7,13,14,15,20,21,27,28];
  const HOLYDAYS_MONTH_2022_9 = [3,4,10,11,17,18,24,25];
  const HOLYDAYS_MONTH_2022_10 = [1,2,8,9,15,16,22,23,29,30];	
  const HOLYDAYS_MONTH_2022_11 = [1,5,6,11,12,13,19,20,26,27,11];	
  const HOLYDAYS_MONTH_2022_12 = [3,4,10,11,17,18,24,25,26,31];
