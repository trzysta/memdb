...
JEŻELI( DZIEŃ.TYG(C$2;1) = 1; "N"; 
JEŻELI( DZIEŃ.TYG(C$2;1) = 2; "P";
JEŻELI( DZIEŃ.TYG(C$2;1) = 3; "W";
JEŻELI( DZIEŃ.TYG(C$2;1) = 1; "Ś";
JEŻELI( DZIEŃ.TYG(C$2;1) = 1; "C";
JEŻELI( DZIEŃ.TYG(C$2;1) = 1; "P"; "S" ))))))
