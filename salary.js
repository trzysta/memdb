  ...
  constructor(e) {
    ...
    try {
      if (e !== undefined) {
        ...
        if (this.entry.field(SAL_FIELD_CLOSED) ==
      ...
      this.closeSettlement = function (reopenEntry) {
        ...
        try {
          ...
          if (this.canCloseSettlement(true)) {
            if (!this.isVisible)
              entry.set(FIELD_CAN_ACCESS, true);
            if (this.dateWithdrwal != null &&
              this.amountWithdrwal > 0) {
      ...
      this.canCloseSettlement = function (showAlert) {
        ...
        try {
          ...
          if (this.amountCash + this.amountWithdrwal > 0 &&
            this.isClosed == false) {
            can = true;
          } else if (showAlert) {
            message(SAL_ERR_CLOSED_OR_NOACCESS);
